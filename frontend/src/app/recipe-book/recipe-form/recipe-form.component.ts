...
export class RecipeFormComponent implements OnInit {
  ...
  submitRecipe(newRecipe) {
    this.recipeService.addRecipe(newRecipe).subscribe((response: any) => {
      this.recipeService
        .addIngredients(response._id, this.parseIngredients(this.form.get('ingredients')?.value))
        .subscribe();
  ...
  updateRecipe(newRecipe) {
    this.recipeService.updateRecipe(this.selectedRecipeId, newRecipe).subscribe(() => {
      this.recipeService
        .updateIngredients(
